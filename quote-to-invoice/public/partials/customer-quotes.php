			...
			<tbody>
				<?php foreach ( $quotes as $quote ) : ?>
					<tr>
						...
						<td>
							<a href="<?php echo esc_url( add_query_arg( array( 'view_quote' => $quote->id ), qti_get_customer_dashboard_url() ) ); ?>" class="button"><?php _e( 'View', 'quote-to-invoice' ); ?></a>
							<?php if ( $quote->status === 'pending' ) : ?>
								<a href="<?php echo esc_url( add_query_arg( array( 'accept_quote' => $quote->id ), qti_get_customer_dashboard_url() ) ); ?>" class="button"><?php _e( 'Accept', 'quote-to-invoice' ); ?></a>
							<?php endif; ?>
						</td>
					</tr>
				<?php endforeach; ?>
